...
import { loginAsync, loginGoogle } from '../../redux/actions/actionLogin'
      ...
      <>
          <div id="template-bg-1" className="bg-image" style={{
              ...
              <div
                  ...
                  <div className='d-flex justify-content-center'><img src='https://res.cloudinary.com/dmaviub4l/image/upload/v1654203909/nwb9arjqyzkbbdezz0ad.webp' alt='pokebola' style={{ width: `15vh` }} /></div>
